      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("medias",$where);
                     ?>
        <!-- Custom Tabs -->
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control input-sm" name="title" placeholder="Enter Title" maxlength="100" value="<?php echo $t=$BindData['title'] ?? ''; ?>" required>
                  </div>
                  <div class="form-group col-md-4 col-xs-12">
...
<?php
     ...
     ?>
              ...
              <div class="tab-pane <?php echo $act2;?>" id="tab_2">
                <div class="box">
                    ...
                    <td><a href="../<?php echo $row['file_url'];?>" style="cursor:pointer;" class="btn btn-primary btn-xs example-image-link" data-lightbox="example-1" ><i class="fa fa-eye" ></i></a>&nbsp;&nbsp;<a href="../<?php echo $row['file_url'];?>" style="cursor:pointer;" class="btn btn-success btn-xs" download><i class="fa fa-download" ></i></a></td>
          ...
          <td><?php echo $sts=$row['status'] != 0 ? '<small class="label bg-green">Yes</small>': '<small class="label bg-red">No</small>'; ?></td>

           <td> <a href="medias.php?id=<?php echo $row['id'];?>&sid=<?php echo $_REQUEST['sid']; ?>" style="cursor:pointer;" class="btn btn-primary btn-xs" ><i class="fa fa-edit" ></i></a>&nbsp;&nbsp;

            <a  href="javascript:void(0);" onclick="javascript:deleteThisRecord(<?php echo $row['id']; ?>,'medias');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
  ...
  function 	RefreshView() {
  	self.location="medias.php?m=active&sid=<?php echo $_REQUEST['sid']; ?>";
}
$(function () {
$('#example2').DataTable({
   "order": [[ 0, "desc" ]],
