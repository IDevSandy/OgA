<?php include('include/header.php');?>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("brands",$where);
                     ?>
        <!-- Custom Tabs -->
        <div class="nav-tabs-custom1 tab">
            <ul class="nav nav-tabs">
              ...
              <li class="<?php echo $act2;?>"><a href="#tab_2" data-toggle="tab"> <i class="fa fa-table"></i> List Brands</a></li>
              ...
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                ...
                <div class="row">
  				...
  				<div class="form-group col-md-3 col-xs-12">
                    ...
                    <input type="text" class="form-control input-sm" name="title" placeholder="Enter Full Name" maxlength="300" value="<?php echo $t=$BindData['title'] ?? ''; ?>" required>
                  </div>
                  <div class="form-group col-md-3 col-xs-12">
                            <label for="title">Website Url</label>
                            <input type="text" class="form-control input-sm" name="website_url" placeholder="Enter Website url" maxlength="100" value="<?php echo $ct=$BindData['website_url'] ?? ''; ?>" required>
                          </div>
  ...
  function 	RefreshView() {
  	self.location="brands.php?m=active";
}
...
$(function () {
  $('#memListTable').DataTable({
       ...
       'aaSorting' : [[0, 'desc']],
       'ajax': {
           'url':'api-controller.php?action=get_brands'
       },
       'columns': [
