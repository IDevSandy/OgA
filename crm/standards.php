<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Standards Management
        <!-- <small>Loading example</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>

        <li class="active">Standards Management</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("standards",$where);
                     ?>
        <!-- Custom Tabs -->
        <div class="nav-tabs-custom1 tab">
            <ul class="nav nav-tabs">
              ...
              <li class="<?php echo $act2;?>"><a href="#tab_2" data-toggle="tab"> <i class="fa fa-table"></i> List Standards</a></li>
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                <form role="form" action="engine-controller.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="action" value="standards">
                  <input type="hidden" name="id" value="<?php echo $id=$_REQUEST['id'] ?? ''; ?>">
                <div class="row">

                  <div class="form-group col-md-6 col-xs-12">
                            <label for="title">Title/No.</label>
                            <input type="text" class="form-control input-sm" name="title" placeholder="Enter Title/Number" maxlength="300" value="<?php echo $t=$BindData['title'] ?? ''; ?>" required>
                          </div>

                          <div class="form-group col-md-6 col-xs-12">
                                    <label for="title">Name</label>
                                    <input type="text" class="form-control input-sm" name="name" placeholder="Enter Standard Name" maxlength="300" value="<?php echo $n=$BindData['name'] ?? ''; ?>" required>
                                  </div>
                                  <div class="form-group col-md-6 col-xs-12">
                                       ...
                                       <?php foreach($years as $year) : ?>
                                         <option value="<?php echo $year; ?>" <?php echo $y=isset($BindData['year']) && $BindData['year']==$year ? 'selected=selected' :''; ?>><?php echo $year; ?></option>
                                       <?php endforeach; ?>
              ...
              <div class="col-xs-12">
                <div class="form-group">
                    <label for="title">Amendments/ Remarks</label>
                    <textarea class="form-control input-sm" name="remarks" placeholder="Enter Amendments/ Remarks"><?php echo $r=$BindData['remarks'] ?? ''; ?></textarea>
                  </div>
  ...
  function 	RefreshView() {
  	self.location="standards.php?m=active";
}
...
$(function () {
  $('#memListTable').DataTable({
       ...
       'aaSorting' : [[0, 'desc']],
       'ajax': {
           'url':'api-controller.php?action=get_standards'
       },
       'columns': [
