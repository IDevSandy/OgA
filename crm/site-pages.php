<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Site Page Management
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("site_pages",$where);
                     ?>
        <!-- Custom Tabs -->
        <div class="nav-tabs-custom1 tab">
            <ul class="nav nav-tabs">
              ...
              <li class="<?php echo $act2;?>"><a href="#tab_2" data-toggle="tab"> <i class="fa fa-table"></i> List Site Pages</a></li>
                  ...
                  <div class="form-group col-md-4 col-xs-12">
                         ...
                         <option value="0" <?php echo $t=isset($BindData['status']) && $BindData['status']=='0' ? 'selected=selected' :''; ?>>Inactive</option>
                           ...
                           <div class="form-group  col-xs-12">
                               <label for="title">Page Contents</label>
                               <textarea class="form-control input-sm ckeditor" name="html" placeholder="Enter html/ Remarks for page Contents" required><?php echo $r=$BindData['html'] ?? ''; ?></textarea>
                             </div>
</div> <!-- End row 1-->
...
$(function () {
  $('#memListTable').DataTable({
       ...
       'aaSorting' : [[0, 'desc']],
       'ajax': {
           'url':'api-controller.php?action=get_sitepages'
       },
       'columns': [
   ...
   $(document).on("click", ".open-AddBookDialog", function () {
        ...
        if(myBookId != "") {
          $.ajax({
              ...
              data: {
                  action: 'get_sitepages_records',tbl:'sitle_pages',id:myBookId
              },
               async: true,
               dataType: "json",
