<?php include('include/header.php');?>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("gallery",$where);
                     ?>
        <!-- Custom Tabs -->
        <div class="nav-tabs-custom1 tab">
            <ul class="nav nav-tabs">
              ...
              <li class="<?php echo $act2;?>"><a href="#tab_2" data-toggle="tab"> <i class="fa fa-table"></i> List Gallery</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control input-sm" name="description" placeholder="Enter Description"><?php echo $r=$BindData['description'] ?? ''; ?></textarea>
                  </div>
  ...
  function 	RefreshView() {
  	self.location="gallery.php?m=active";
}
...
$(function () {
  $('#memListTable').DataTable({
       ...
       'aaSorting' : [[0, 'desc']],
       'ajax': {
           'url':'api-controller.php?action=get_gallery'
       },
       'columns': [
