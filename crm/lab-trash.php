<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Laboratory Trash
        <!-- <small>Loading example</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>

        <li class="active">Laboratory Trash</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box">
               ...
               $myrow = $obj->fetch_all_record("laboratories",$where);
 $sn=1;
               if($myrow != null) {
             ...
             $varact2= $row['is_deleted'] != 0 ? '<a href="#!" onclick="javascript:restore('.$row['id'].',\'laboratories\');" class="btn btn-info btn-xs"> <i class="fa fa-undo"></i></a>&nbsp;<a href="#!" onclick="javascript:deleteThisRecord('.$row['id'].',\'laboratories\');" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i></a>':'<a href="#!" onclick="javascript:deleteThisRow('.$row['id'].',\'laboratories\');" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i></a>';
  ...
  function 	RefreshView() {
  	self.location="lab-trash.php?m=active";
}
$(function () {
$('#example2').DataTable({
   "order": [[ 0, "desc" ]],
