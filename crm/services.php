              ...
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-4 col-xs-12">
                            ...
                            <input type="text" class="form-control input-sm" name="title" placeholder="Enter Service Name" maxlength="300" value="<?php echo $t=$BindData['title'] ?? ''; ?>" required onchange="UpdateLink(this.value);"/>
                          </div>
<div class="form-group col-md-4 col-xs-12">
                            <label for="title">Custom url</label>
                            <input type="text" class="form-control input-sm" name="custom_url" placeholder="Enter Custom url" maxlength="300" id="plink" value="<?php echo $t=$BindData['custom_url'] ?? ''; ?>" required>
                          </div>
						  <div class="form-group col-md-4 col-xs-12">

                             <label for="status">Hp Status</label>
                             <select name="hp_status" class="form-control input-sm" >
                         <option value="1" <?php echo $t=isset($BindData['hp_status']) && $BindData['hp_status']=='1' ? 'selected=selected' :''; ?>>Show</option>
                         <option value="0" <?php echo $t=isset($BindData['hp_status']) && $BindData['hp_status']=='0' ? 'selected=selected' :''; ?>>Hide</option>
 ...
 <input id="name6" type="tel"  name="authority_fee" placeholder="Enter Authority Fee" class="form-control input-sm" maxlength="6" value="<?php echo $af=$BindData['authority_fee'] ?? ''; ?>" onkeypress="javascript:allowNumeric(this,event);" required>
                           ...
                           <div class="form-group col-md-4 col-xs-12">
                                     <label for="title">Market Price (<i class = "fa fa-inr"></i>)</label>
  <input id="name7" type="tel"  name="charge"  placeholder="Enter Charge" class="form-control input-sm" maxlength="6" value="<?php echo $cf=$BindData['charge'] ?? ''; ?>" onkeypress="javascript:allowNumeric(this,event);" required>
                            ...
                            <div class="form-group col-md-4 col-xs-12">
                                      <label for="title">Offer Price (<i class = "fa fa-inr"></i>)</label>
   <input  type="tel"  name="offer_price"  placeholder="Enter Charge" class="form-control input-sm" maxlength="6" value="<?php echo $cf=$BindData['offer_price'] ?? ''; ?>" onkeypress="javascript:allowNumeric(this,event);" required>
                             </div>
                  ...
                  <div class="form-group col-md-4 col-xs-12">
                         ...
                         <option value="0" <?php echo $t=isset($BindData['status']) && $BindData['status']=='0' ? 'selected=selected' :''; ?>>Inactive</option>
                           ...
                           <div class="form-group col-xs-12">
                               ...
                               <textarea class="form-control input-sm ckeditor" rows="5" name="description" placeholder="Enter Description/ Remarks"><?php echo $r=$BindData['process_layouts'] ?? ''; ?></textarea>
                             </div>
                         </div> 
						 <!-- End row 1-->
...
$(function () {
  ...
  function UpdateLink(e) {
	     var temp=e.replace(/[&\/\\#,+()$~%.'":*?<>{}]/g,'');

     var link=temp.replace(/ /g,"-");
     if(e !="") {
