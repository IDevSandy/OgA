<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Process Layouts Management
        <!-- <small>Loading example</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>

        <li class="active">Process Layouts Management</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("process_layouts",$where);
                     ?>
        <!-- Custom Tabs -->
        <div class="nav-tabs-custom1 tab">
            <ul class="nav nav-tabs">
              ...
              <li class="<?php echo $act2;?>"><a href="#tab_2" data-toggle="tab"> <i class="fa fa-table"></i> List Layouts</a></li>
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                <form role="form" action="engine-controller.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="action" value="process_layouts">
                  ...
                  <div class="form-group col-md-6 col-xs-12">
                         ...
                         <option value="0" <?php echo $t=isset($BindData['status']) && $BindData['status']=='0' ? 'selected=selected' :''; ?>>Inactive</option>
                           ...
                           <div class="form-group  col-xs-12">
                               ...
                               <textarea class="form-control input-sm" name="description" placeholder="Enter Description" rows="4" required><?php echo $r=$BindData['description'] ?? ''; ?></textarea>
                             </div>
              <div class="col-xs-12">
                           ...
                           <th>Status</th>
                            <th>Action</th>
                               ...
                               <tbody id="tbody">
                                 ...
                                 $myrow = $obj->fetch_all_record("process_layouts",$where);
                                 if($myrow != null) {
                                 ...
                                 <td> <a href="process-layouts.php?id=<?php echo $row['id'];?>" style="cursor:pointer;" class="btn btn-primary btn-xs" ><i class="fa fa-edit" ></i></a>&nbsp;&nbsp;

                                 <a  href="javascript:void(0);" onclick="javascript:deleteThisRecord(<?php echo $row['id']; ?>,'process_layouts');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
  ...
  function 	RefreshView() {
  	self.location="process-layouts.php?m=active";
}
