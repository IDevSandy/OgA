<?php include('include/header.php');?>
  ...
  // $restAmount=mysqli_fetch_array(mysqli_query($obj->con,"select SUM(Quantity) AS TotalItemsOrdered  from projects where id=".$_REQUEST['pid'])
        $title='';
        $btn='';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page --> Payments for <a href="projects.php?id=<?php echo $_REQUEST['pid']; ?>"><?php echo $ptitle['title'];?></a>
