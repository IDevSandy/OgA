<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Add Documents for <a href="clients.php?id=<?php echo $_REQUEST['cid']; ?>"><?php echo $ptitle['title'];?></a>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Client Attachments Management</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("client_attachments",$where);
                     ?>
        <!-- Custom Tabs -->
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                <form role="form" action="engine-controller.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="action" value="client_attachments">
                  <input type="hidden" name="id" value="<?php echo $id=$_REQUEST['id'] ?? ''; ?>">
                  <input type="hidden" name="cid" value="<?php echo $cid=$_REQUEST['cid'] ?? ''; ?>">
                <div class="row">
...
<a href="../<?php echo $BindData['file_url'];?>" style="cursor:pointer;" class="btn btn-success btn-xs pull-right" target="_blank"><i class="fa fa-eye" ></i> View Attachment</a>
   <?php
              ...
              <div class="tab-pane <?php echo $act2;?>" id="tab_2">
                <div class="box">
                         ...
                         $myrow = $obj->fetch_all_record("client_attachments",$where);
                         if($myrow != null) {
          ...
          <td><?php echo $sts=$row['status'] != 0 ? '<small class="label bg-green">Active</small>': '<small class="label bg-red">Inactive</small>'; ?></td>
           ...
           <td> <a href="clientattachments.php?id=<?php echo $row['id'];?>&cid=<?php echo $_REQUEST['cid']; ?>" style="cursor:pointer;" class="btn btn-primary btn-xs" ><i class="fa fa-edit" ></i></a>&nbsp;&nbsp;

            <a  href="javascript:void(0);" onclick="javascript:deleteThisRecord(<?php echo $row['id']; ?>,'client_attachments');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
  ...
  function 	RefreshView() {
  	self.location="clientattachments.php?m=active&cid=<?php echo $_REQUEST['cid']; ?>";
}
$(function () {
$('#example2').DataTable({
   "order": [[ 0, "desc" ]],
