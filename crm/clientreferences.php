<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Add References for <a href="clients.php?id=<?php echo $_REQUEST['cid']; ?>"><?php echo $ptitle['title'];?></a>
        <!-- <small>Loading example</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
<li><a href="clients.php"><i class="fa fa-users"></i>Clients</a></li>
        <li class="active">Client References Management</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <?php
            require_once('include/countryCodes.php');
                     ...
                     $BindData=$obj->select_record("client_references",$where);
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                <form role="form" action="engine-controller.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="action" value="client_references">
 ...
 <input id="name6" type="tel"  name="mobile2" placeholder="Enter Mobile Number2" class="form-control input-sm" maxlength="10" value="<?php echo $af=$mob2[1] ?? ''; ?>" onkeypress="javascript:allowNumeric(this,event);" >
              ...
              <div class="tab-pane <?php echo $act2;?>" id="tab_2">
                <div class="box">
                         ...
                         $myrow = $obj->fetch_all_record("client_references",$where);
                         if($myrow != null) {
          ...
          <td><?php echo $sts=$row['status'] != 0 ? '<small class="label bg-green">Active</small>': '<small class="label bg-red">Inactive</small>'; ?></td>
           ...
           <td> <a href="clientreferences.php?id=<?php echo $row['id'];?>&cid=<?php echo $_REQUEST['cid']; ?>" style="cursor:pointer;" class="btn btn-primary btn-xs" ><i class="fa fa-edit" ></i></a>&nbsp;&nbsp;
  ...
  function 	RefreshView() {
  	self.location="clientreferences.php?m=active&cid=<?php echo $_REQUEST['cid']; ?>";
}
$(function () {
$('#example2').DataTable({
   "order": [[ 0, "desc" ]],
