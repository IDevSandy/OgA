                  ...
                  <div class="form-group col-md-3 col-xs-12">
                         ...
                         <option value="0" <?php echo $t=isset($BindData['status']) && $BindData['status']=='0' ? 'selected=selected' :''; ?>>Inactive</option>
                           ...
                           <div class="form-group col-xs-12">
                               ...
                               <textarea class="form-control input-sm ckeditor" rows="5" name="process_layouts" placeholder="Enter Description/ Remarks"><?php echo $r=$BindData['process_layouts'] ?? ''; ?></textarea>
                             </div>
                         </div> <!-- End row 1-->
