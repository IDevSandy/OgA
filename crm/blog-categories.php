<?php include('include/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!-- Pace page -->Blog Categories Management
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                     ...
                     $BindData=$obj->select_record("blog_categories",$where);
                     ?>
        <!-- Custom Tabs -->
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo $act1;?>" id="tab_1">
                <form role="form" action="engine-controller.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="action" value="blog_categories">
  ...
  function 	RefreshView() {
  	self.location="blog-categories.php?m=active";
}
$(function () {
  $('#memListTable').DataTable({
       ...
       'aaSorting' : [[0, 'desc']],
       'ajax': {
           'url':'api-controller.php?action=get_blog_categories'
       },
       'columns': [
   ...
   $(document).on("click", ".open-AddBookDialog", function () {
        ...
        if(myBookId != "") {
          $.ajax({
              ...
              data: {
                  action: 'get_blog_categories_records',tbl:'blog_categories',id:myBookId
              },
               async: true,
               dataType: "json",
