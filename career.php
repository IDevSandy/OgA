            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="sports-inner">
                        <h3 class="category-headding "> How to Crack the CAPF Exam?</h3>
                        <div class="headding-border bg-color-1"></div>
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
                            <h3><a href="#">How Prepare Central Armed Police Force(CAPF)</a></h3>
                            <!-- post image -->
                            <div class="post-thumb">
                                <a href="#">
                                    <img src="images/UPSC-CAPF-AC.jpg" class="img-responsive" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="post-title-author-details">
                            ...
                            <p>    The CAPF AC test is held every year by the UPSC to select young people for the rank of Assistant Commandant in the CAPF.  <a href="#">Read more...</a></p>
                        </div>
                    </div>
                </div>
                <!-- /.sports -->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="food-inner">
                        <h3 class="category-headding ">CAREER IN CIVIL SERVICES</h3>
                        <div class="headding-border bg-color-4"></div>
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
